...
class TradingEngine:
    ...
    def _is_signal_coherent(
        ...
        z_hard_cap = 999.0 if is_trending else 4.0
        ...
        if signal_type == "BUY":
            ...
            # En tendencia fuerte (ADX>30), permitimos comprar breakouts ilimitados respecto al VWAP macro.
            z_buy_max = 999.0 if is_trending else 0.5
            ...
            z_sell_min = -999.0 if is_trending else -0.5
